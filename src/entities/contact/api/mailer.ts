...
import type { SendEmailPayload } from "@types/index";

export async function sendEmail(props: SendEmailPayload): Promise<nodemailer.SentMessageInfo> {
  const config = {
    email: import.meta.env.EMAIL as string,
    pass: import.meta.env.EMAIL_PASS as string,
  };
