import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as renderComponent, b as createAstro, e as addAttribute, f as renderHead, g as renderSlot } from './astro/server_CJ5Zltcn.mjs';
import 'kleur/colors';
/* empty css                         */
import 'clsx';
...
const $$BaseHead = createComponent(($$result, $$props, $$slots) => {
  ...
  const {
    title,
    description,
    image = "img/icons/sofi-icon.webp"
  } = Astro2.props;
